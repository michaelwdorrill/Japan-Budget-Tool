...
const prices: PriceRecord[] = [
  ...
  // 'testville' exists only to exercise the per-night tax-rule switch.
  { id: 'lodging_testville_business', label: 'Business hotel, Testville', cityId: 'testville', category: 'lodging', tier: 'business', basis: 'per_room_per_night', low: 8000, expected: 10000, high: 12000, asOf: '2026-01-01', source: 'test', confidence: 'high' },
  ...
  { id: 'lodging_hakone_business', label: 'Business hotel, Hakone', cityId: 'hakone', category: 'lodging', tier: 'business', basis: 'per_room_per_night', low: 9000, expected: 11000, high: 14000, asOf: '2026-01-01', source: 'test', confidence: 'high' },
  { id: 'local_transit_hakone', label: 'Local transit, Hakone', cityId: 'hakone', category: 'local_transport', basis: 'per_person_per_day', low: 500, expected: 800, high: 1200, asOf: '2026-01-01', source: 'test', confidence: 'high' },
  { id: 'local_transit_testville', label: 'Local transit, Testville', cityId: 'testville', category: 'local_transport', basis: 'per_person_per_day', low: 500, expected: 700, high: 1000, asOf: '2026-01-01', source: 'test', confidence: 'high' },
...
export const testPriceData: PriceData = {
  cities: [
    ...
    { id: 'hakone', name: 'Hakone', region: 'Kanto', airports: [] },
    { id: 'hiroshima', name: 'Hiroshima', region: 'Chugoku', airports: [] },
    { id: 'testville', name: 'Testville', region: 'Test', airports: [] },
  ],
  prices,
  railFares: [
    {
    ...
    },
    {
      ...
      operator: 'private',
      line: 'Test private railway',
      durationMinutes: 90,
      fareJpyUnreserved: 2000,
      fareJpyReserved: 2470,
      asOf: '2026-01-01',
      source: 'test',
      confidence: 'high',
    },
  ...
  passes: {
    ...
    regionalPasses: [
      {
        id: 'test_regional_withdrawn',
        label: 'Test withdrawn regional pass',
        operator: 'Test Operator',
        coverage: ['tokyo', 'kyoto'],
        days: 5,
        priceJpy: 1000,
        railClass: 'ordinary',
        childDiscountPct: 50,
        salesEndDate: '2026-03-13',
        asOf: '2026-01-01',
        source: 'test',
        confidence: 'high',
      },
    ...
    discountProducts: [
      ...
      {
        id: 'test_cheaper_bus_tokyo_kyoto',
        label: 'Test cheaper highway bus, Tokyo-Kyoto',
        route: 'tokyo-kyoto',
        priceJpy: 6500,
        salesEndDate: null,
        asOf: '2026-01-01',
  ...
  taxes: {
    accommodationTax: [
      ...
      },
      {
        ...
        percentageOfRate: 3,
        // Mirrors Tokyo's real announced exemption floor so the engine's
        // handling of it is exercised by the unit suite too.
        exemptionBelowJpy: 13000,
        asOf: '2026-01-01',
        source: 'test',
        confidence: 'high',
      },
      // A two-period city used to prove the tax rule is picked per night,
      // not once for the whole leg: ¥100/night before 2026-06-15, ¥200 on
      // and after it.
      {
        id: 'testville_before',
        cityId: 'testville',
